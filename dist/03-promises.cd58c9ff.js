...
btnStart.addEventListener("click", (e)=>{
    e.preventDefault();
    let delay1 = Number(firstDelay.value), step = Number(delayStep.value);
    for(let i = 0; i < amount.value; i++)createPromise(1 + i, delay1 + i * step).then(({ position , delay  })=>{
...
},{}]},["dDjGg","8tzFL"], "8tzFL", "parcelRequireb7d1")
