...
const input = document.getElementById("datetime-picker"), btnStart = document.querySelector("[data-start]"), daysValue = document.querySelector("[data-days]"), hoursValue = document.querySelector("[data-hours]"), minValue = document.querySelector("[data-minutes]"), secValue = document.querySelector("[data-seconds]");
...
const options = {
    ...
    onClose (selectedDates) {
        if (selectedDates[0].getTime() < options.defaultDate.getTime()) (0, _notiflix.Notify).failure("Please choose a date in the future");
        else {
...
},{}]},["8lKsl","1AWyZ"], "1AWyZ", "parcelRequireb7d1")
